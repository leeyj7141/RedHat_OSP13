...
#  with ip pool, with scheduler hints , with mgmt network, no swift
# ceph radosgw swift integrate test
# deploy success !! 


#echo ---- openstack stack delete start -------------
#openstack stack delete yj23-osp13-15 --yes --wait
...
echo ---- stack 20 start ironic dvr with no ovn ----
...
-e /home/stack/templates/network-environment_ironic_dvr.yaml \
...
--log-file=/home/stack/log/overcloud_deploy-`date +%Y%m%d-%H:%M`.log
